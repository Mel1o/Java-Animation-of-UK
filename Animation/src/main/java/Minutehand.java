/**
	The Minute hand class. it is only a small part of the canvas. Moves at a much faster rate than the Hour hand.
...
*/
import java. awt.*;
public class Minutehand implements DrawingObject {
    ...
    public void draw(Graphics2D g2d){
        ...
        t = new Triangle(510.5,196,4,4,color);
        r = new Rectangle(510.5, 200,514.5,230, color);
